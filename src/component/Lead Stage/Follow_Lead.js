...
const StandByRequest = forwardRef((props, ref) => {
  ...
  //       color="neutral"
  //       variant="soft"
  //       sx={{ backgroundColor: "#FFF9C4", color: "#000" }}
  //     >
  //       Followup
  //     </Chip>
  //   );
        ...
        <Menu size="sm" sx={{ minWidth: 140 }}>
          ...
          <MenuItem
            ...
            onClick={() => {
              ...
              const leadId = String(id);
              // const projectID = Number(p_id);
              localStorage.setItem("view_follow_history", leadId);
              // localStorage.setItem("p_id", projectID);
              navigate(`/followup_records?page=${page}&${leadId}`);
            }}
          >
            <ManageHistoryIcon />
          ...
          <MenuItem
            ...
            onClick={() => {
              ...
              // localStorage.setItem("p_id", projectID);
              navigate(`/add_task_followup?page=${page}&${leadId}`);
            }}
          >
  ...
  useImperativeHandle(ref, () => ({
    exportToCSV() {
      ...
      link.download =
        selected.length > 0 ? "Selected_Leads.csv" : "Followup_Leads.csv";
      link.click();
    },
  }));
