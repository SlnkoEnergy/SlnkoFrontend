...
const StandByRequest = forwardRef((props, ref) => {
        ...
        <Menu size="sm" sx={{ minWidth: 140 }}>
          <MenuItem
            ...
            onClick={() => {
              ...
              localStorage.setItem("edit_warm", leadId);
              // localStorage.setItem("p_id", projectID);
              navigate(`/edit_warm?page=${page}&id=${leadId}`);
            }}
          >
            <ContentPasteGoIcon />
            <Typography>Edit Warm</Typography>
          </MenuItem>
          <MenuItem
            color="primary"
            onClick={() => {
          ...
          <MenuItem
            ...
            onClick={() => {
              ...
              // localStorage.setItem("p_id", projectID);
              navigate(`/add_task_warm?page=${page}&${leadId}`);
            }}
          >
          ...
          <MenuItem
            ...
            onClick={() => {
              ...
              const leadId = String(id);
              // const projectID = Number(p_id);
              localStorage.setItem("view_warm", leadId);
              // localStorage.setItem("p_id", projectID);
              navigate(`/warm_Summary?page=${page}&id=${leadId}`);
            }}
          >
            <RemoveRedEyeIcon />
            <Typography>Warm Summary</Typography>
          </MenuItem>
  ...
  useImperativeHandle(ref, () => ({
    exportToCSV() {
      ...
      link.download =
        selected.length > 0 ? "Selected_Leads.csv" : "Warm_Leads.csv";
      link.click();
    },
  }));
