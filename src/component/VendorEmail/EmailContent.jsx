  ...
  return (
    <Sheet variant="outlined" sx={{ minHeight: 500, borderRadius: "sm", p: 2, mb: 3 }}>
      ...
      >
        ...
        <Box sx={{ display: "flex", height: "32px", flexDirection: "row", gap: 1.5 }}>
          ...
          <Snackbar
            ...
            endDecorator={
              <Button onClick={() => handleSnackbarClose(0)} size="sm" variant="soft" color="neutral">
                Dismiss
              </Button>
            }
          >
          ...
          <Snackbar
            ...
            startDecorator={<CheckCircleRoundedIcon />}
            endDecorator={
              <Button onClick={() => handleSnackbarClose(1)} size="sm" variant="soft" color="neutral">
                Dismiss
              </Button>
            }
          >
          ...
          <Snackbar
            ...
            startDecorator={<CheckCircleRoundedIcon />}
            endDecorator={
              <Button onClick={() => handleSnackbarClose(2)} size="sm" variant="soft" color="neutral">
                Dismiss
              </Button>
            }
          >
      ...
      <Typography level="body-sm" sx={{ mt: 2, mb: 2 }}>
        ...
        glaciers, and a lot of biological diversity. It is amazing that almost 95 percent of the
        ...
        <br />
        <br />
        I really hope you love coming along with me, we will have an awesome time! I&apos;m attaching
        a few pics I took on the last time I went there—get excited!
        <br />
        <br />
