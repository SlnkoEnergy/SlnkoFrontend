        ...
        <Grid item xs={12} sm={4} md={4}>
          ...
          >
            <Chip
              ...
              variant="soft"
              color={
                (Number(responseData?.gst_difference) ?? 0) >= 0
                  ? "success"
                  : "danger"
              }
              sx={{ fontWeight: "bold" }}
            >
              ...
              >
                ...
                {isLoading
                  ? "• • •"
                  : formatIndianNumber(responseData?.gst_difference)}
              </span>
            </Chip>
                          ...
                          {isLoading ? (
                            ...
                            ClientSummary.map((client) => (
                              <tr key={client._id}>
                                ...
                                <td className="num em">
                                  ₹{" "}
                                  {Number(client.po_basic || 0).toLocaleString(
                                    "en-IN"
                                  )}
                                </td>
                                <td className="num em">
                                  ₹{" "}
                                  {Number(client.gst || 0).toLocaleString(
                                    "en-IN"
                                  )}
                                </td>
                                <td className="num em">
                                ...
                                <td className="num em">
                                  ₹{" "}
                                  {Number(client.bill_gst || 0).toLocaleString(
                                    "en-IN"
                                  )}
                                </td>
                                <td className="num em">
                        ...
                        {ClientSummary.length > 0 && (
                          <tfoot>
                            <tr>
                              ...
                              <td className="num em">
                                ₹{" "}
                                {ClientTotal.total_po_basic?.toLocaleString(
                                  "en-IN"
                                )}
                              </td>
                              <td className="num em">
                                ₹{" "}
                                {ClientTotal.total_gst?.toLocaleString("en-IN")}
                              </td>
                              <td className="num em">
                                ₹{" "}
                              ...
                              <td className="num em">
                                ₹{" "}
                                {ClientTotal.total_bill_basic?.toLocaleString(
                                  "en-IN"
                                )}
                              </td>
                              <td className="num em">
                                ₹{" "}
                                {ClientTotal.total_bill_gst?.toLocaleString(
                                  "en-IN"
                                )}
                              </td>
                              <td className="num em">
