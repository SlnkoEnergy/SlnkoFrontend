  ...
  const renderFilters = () => (
    <>
      <FormControl size="sm">
        ...
        >
          <Option value="paid">A</Option>
          <Option value="pending">B</Option>
          <Option value="refunded">C</Option>
          <Option value="cancelled">D</Option>
        </Select>
      </FormControl>
      {/* <FormControl size="sm">
      ...
      >
        ...
        <TableHead>
          <TableRow>
            ...
            <TableCell>Slnko Service Charges (with GST)</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
