...
const Summary = () => {
      ...
      >
        ...
        >
           <Box
            ...
            <Box sx={{ width: "100%", padding:'7px 10px', '@media print':{marginTop:'20px'} }}>
  <Typography
    variant="h6"
    sx={{
      fontWeight: "bold",
  ...
  >
    <Box sx={{ px: 2, "@media print": { pl: 1 } }}>
      <Typography sx={{'@media print':{fontSize:'1.2rem'}}} fontWeight="bold">1. Control Room</Typography>
      <Typography sx={{'@media print':{fontSize:'1.2rem'}}} fontWeight="bold">2. Water Arrangement</Typography>
      <Typography sx={{'@media print':{fontSize:'1.2rem'}}} fontWeight="bold">3. Boundary Wall / Fencing</Typography>
    </Box>
    <Box sx={{ px: 2, "@media print": { pl: 1 } }}>
      <Typography sx={{'@media print':{fontSize:'1.2rem'}}} fontWeight="bold">4. Road & Drainage System</Typography>
      <Typography sx={{'@media print':{fontSize:'1.2rem'}}} fontWeight="bold">5. WMS (Weather Monitoring System)</Typography>
      <Typography sx={{'@media print':{fontSize:'1.2rem'}}} fontWeight="bold">6. ROW (Right of Way)</Typography>
    </Box>
    <Box sx={{ px: 2, "@media print": { pl: 1 } }}>
      <Typography sx={{'@media print':{fontSize:'1.2rem'}}} fontWeight="bold">7. Dry Cleaning Robot</Typography>
      <Typography sx={{'@media print':{fontSize:'1.2rem'}}} fontWeight="bold">
